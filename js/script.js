...
document.getElementById("vaticano").onclick = () => { window.location.href = "https://www.vatican.va/content/vatican/pt.html" };
document.getElementById("cancelar").onclick = () => { overlay.style.display = "none"; caixa_form.style.display = "none"; };
document.getElementById("reset").onclick = () => { localStorage.clear(); window.location.reload(); }
